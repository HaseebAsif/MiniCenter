  ...
  return (
    <section className="research-page relative overflow-hidden z-0">
      <section className="bg-[#0a2159] min-h-screen">
        <Container>
          <Nav />
          <section className="r-sec-1 h-full md:pt-[10%] pt-[25%] text-white">
            ...
            <div className="img-sec-1 md:flex md:py-10 py-2  items-center">
              ...
              <div className="r-sec-1-text md:text-left text-center md:w-[50%] w-[90%] mx-auto">
                ...
                <p className="md:text-[24px] text-[16px] md:py-8 py-4 leading-[1.5] md:pr-8">
                  ...
                  Steven's work. The algorithm produced results in a fraction of
                  the time it would have taken humans.
                </p>
              </div>
            </div>
            <div className="img-sec-1 md:flex md:py-16 py-2 items-center flex-row-reverse md:gap-32">
              ...
              <div className="r-sec-1-text md:text-left text-center md:w-[50%] w-[90%] mx-auto">
                ...
                <p className="md:text-[24px] text-[16px] md:py-8 py-4 leading-[1.5]">
                  ...
                  part of a research project in Clemson University's Department
                  of Mechanical Engineering. This involved using the YOLO neural
                  network to analyze athletes faces at different stages of
                  exercise intensity, associate with it a level of fatigue, and
                  provide feedback. He also created and tested polynomial-time
                  convex optimization algorithms for YOLO with the Fast R-CNN
                  method to decrease background mistakes and increase accuracy
                  in embedded computer vision systems. This has given Arvind
                  proficiency in the model training process, allowing him to
                  adapt real-time image detection for various objectives.
                </p>
              </div>
            </div>
          </section>
      ...
      <section className="bg-[#eaeefa] min-h-screen">
        <Container>
          <section className="r-sec-2 pt-20 text-black">
